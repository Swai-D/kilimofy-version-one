...
@section('title', 'Market-Product-List-Form')
@section('header')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Market-Product-List-Form</h1>
        </div>
        <div class="col-sm-6">
            ...
            <form action="/kilimofy/Admin/New-Forum-Category-Form-Store" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Market Item Name</label>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="name" rows="8" cols="80" placeholder="simple description"></textarea>
                </div>
                <div class="form-group">
                  <label for="exampleInputFile"> Market Item Image</label>
