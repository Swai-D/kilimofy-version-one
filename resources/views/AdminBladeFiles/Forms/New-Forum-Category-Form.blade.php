        ...
        <div class="col-md-8">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Create New Forum Category</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="/kilimofy/Admin/New-Forum-Category-Form-Store" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="Category_Description" id="exampleInputPassword1" placeholder="Description" rows="8" cols="80"></textarea>
                </div>
                <div class="form-group">
