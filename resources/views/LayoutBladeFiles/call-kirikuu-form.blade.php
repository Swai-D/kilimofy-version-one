<div class="popup-box small popup-call-kirikuu">
  <!-- POPUP CLOSE BUTTON -->
  <div class="popup-close-button popup-call-kirikuu-trigger">
  ...
  <form class="form" action="" method="">
    ...
    <div class="popup-box-actions full void">
      <!-- POPUP BOX ACTION -->
      <button type="submit" class="popup-box-action full button secondary">Call Kirikuu</button>
      <!-- /POPUP BOX ACTION -->
