...
<nav id="navigation-widget-mobile" class="navigation-widget navigation-widget-mobile sidebar left hidden" data-simplebar>
  ...
  <div class="navigation-widget-info-wrap">
    ...
    <div class="navigation-widget-info">
      <!-- USER AVATAR -->
      <a class="user-avatar small no-outline" href="/home">
        <!-- USER AVATAR CONTENT -->
        <div class="user-avatar-content">
          <!-- HEXAGON -->
      ...
      <!-- NAVIGATION WIDGET INFO TITLE -->
      <p class="navigation-widget-info-title"><a href="/home">Mgeni</a></p>
      <!-- /NAVIGATION WIDGET INFO TITLE -->
  ...
  <br>
   ...
   <br>
    ...
    <div class="row">
      <div class="col-8 pull-left">
        <p class="navigation-widget-section-title">login</p>
      </div>
      <div class="col-1 pull-right">
        <p class="navigation-widget-section-title">Sign UP</p>
      </div>
    </div>
    <hr>
    ...
    <li class="menu-item">
      <div class="row">
        <div class="col-9">
          <!-- MENU ITEM LINK -->
            <a href="/home" >
              <img src="/assets/img/user_icon/login.png" alt="logout" style="width:44; height:44;">
            </a>
        ...
        <div class="col-3">
          <a href="/home">
           <img src="/assets/img/user_icon/add-friend.png" alt="" style="width:44; height:44;">
          </a>
        </div>
      </div>
    </li>
