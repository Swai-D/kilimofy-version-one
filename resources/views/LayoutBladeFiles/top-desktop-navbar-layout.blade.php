          ...
          <div class="dropdown-box-list no-hover" data-simplebar>
            ...
            <div class="dropdown-box-list-item">
              ...
              <div class="user-status request">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><a class="bold" href="#">Kilimofy</a></p>
                <!-- /USER STATUS TITLE -->

                <!-- USER STATUS TEXT -->
                <p class="user-status-text">{{mt_rand(1,6)}} friends in common</p>
                <!-- /USER STATUS TEXT -->
          ...
          <div class="dropdown-box-list medium" data-simplebar>
            ...
            <a class="dropdown-box-list-item" href="#">
              ...
              <div class="user-status">
                ...
                <!-- USER STATUS TITLE -->
                <p class="user-status-title"><span class="bold">Welcome to Kilimofy</span></p>
                <!-- /USER STATUS TITLE -->

                <!-- USER STATUS TEXT -->
                <p class="user-status-text">Notifications will be ready in the comming version...</p>
                <!-- /USER STATUS TEXT -->

                <!-- USER STATUS TIMESTAMP -->
                <p class="user-status-timestamp floaty">soon !</p>
                <!-- /USER STATUS TIMESTAMP -->
              </div>
              <!-- /USER STATUS -->
            </a>
          ...
          <div class="dropdown-box-list" data-simplebar>
            ...
            <div class="dropdown-box-list-item unread">
              ...
              <div class="user-status notification">
                ...
                <!-- USER STATUS TIMESTAMP -->
                <p class="user-status-timestamp">soon !</p>
                <!-- /USER STATUS TIMESTAMP -->
       ...
       <div class="dropdown-navigation header-settings-dropdown">
         ...
         <div class="dropdown-navigation-header">
           ...
           <div class="user-status">
             ...
             <!-- /USER STATUS AVATAR -->
             <!-- USER STATUS TITLE -->
             <p class="user-status-title"><span class="bold">Hi {{\Illuminate\Support\Str::limit(Auth::user()->username, 8, '...')}} !</span></p>
             <!-- /USER STATUS TITLE -->
         ...
         <!-- DROPDOWN NAVIGATION LINK -->
         <a class="dropdown-navigation-link" href="/kilimofy/Admin/admin_index_page">
          <img src="/assets/img/user_icon/admin.png" alt="">Admin Panel
         </a>
         <!-- /DROPDOWN NAVIGATION LINK -->
         @endif
    ...
    <div class="action-list dark">
              ...
              <div class="user-status request">
                ...
                <a class="user-status-avatar" href="#">
                  ...
                  <div class="user-avatar small no-outline">
                    ...
                    <div class="user-avatar-content">
                      <!-- HEXAGON -->
                      <div class="hexagon-image-30-32" data-src="/assets/img/user_icon/user.png"></div>
                      <!-- /HEXAGON -->
                    </div>
                    <!-- /USER AVATAR CONTENT -->
     ...
     <div class="action-list-item-wrap">
        ...
        <div class="action-list-item ">
          ...
          <div class="user-avatar small no-border">
            <!-- USER AVATAR -->
            <a class="user-avatar small no-outline online" href="/home">
              <!-- USER AVATAR CONTENT -->
              <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-30-32" data-src="/assets/img/user_icon/user.png"></div>
