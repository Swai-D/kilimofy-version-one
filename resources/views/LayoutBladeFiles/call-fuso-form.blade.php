<div class="popup-box small popup-call-fuso">
  <!-- POPUP CLOSE BUTTON -->
  <div class="popup-close-button popup-call-fuso-trigger">
  ...
  <form class="form" action="" method="">
    ...
    <div class="popup-box-actions full void">
      <!-- POPUP BOX ACTION -->
      <button type="submit" class="popup-box-action full button secondary">Call Fuso</button>
      <!-- /POPUP BOX ACTION -->
