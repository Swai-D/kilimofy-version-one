              ...
              <a class="user-status-avatar" href="/kilimofy/UserAccount/about_user_page/{{$author->id}}-about-Kilimofy-Tz">
                ...
                <div class="user-avatar small no-outline">
                  ...
                  <div class="user-avatar-content">
                    <!-- HEXAGON -->
                    <div class="hexagon-image-30-32" data-src="{{$author->avatar}}"></div>
                    <!-- /HEXAGON -->
                  </div>
                  <!-- /USER AVATAR CONTENT -->
            ...
            <!-- POST COMMENT -->
              ...
              <div class="post-comment">
                ...
                <a class="user-avatar small no-outline" href="#">
                  ...
                  <div class="user-avatar-content">
                    <!-- HEXAGON -->
                    <div class="hexagon-image-30-32" data-src="{{$post_comment->user_avatar}}"></div>
                    <!-- /HEXAGON -->
                  </div>
                  <!-- /USER AVATAR CONTENT -->
              ...
              <div class="post-comment unread reply-2">
                ...
                <a class="user-avatar small no-outline" href="">
                  ...
                  <div class="user-avatar-content">
                    <!-- HEXAGON -->
                    <div class="hexagon-image-30-32" data-src="{{$comment_replies->user_avatar}}"></div>
                    <!-- /HEXAGON -->
                  </div>
                  <!-- /USER AVATAR CONTENT -->
