...
@section('title','Fundi wa Mashine')
@section('menu-status-tool-box','active')
@section('discription-title','Fundi')
...
<section class="section">
  ...
  <div class="section-header">
    ...
    <div class="section-header-info">
      ...
      <!-- SECTION TITLE -->
      <h2 class="section-title">Fundi  <span class="highlighted">({{$total_fundi_list}})</span></h2>
      <!-- /SECTION TITLE -->
    </div>
    <!-- /SECTION HEADER INFO -->
  </div>
...
@endif
  ...
  <div class="grid grid-4-4-4 centered">
    ...
    <div class="user-preview small">
      ...
      <div class="user-preview-info">
        ...
        <div class="user-short-description small">
          ...
          <a class="user-short-description-avatar user-avatar" href="/kilimofy/UserAccount/about_user_page/{{$fundi->id}}-About-{{$fundi->name}}-in-Kilimofy-Platform">
            <!-- USER AVATAR BORDER -->
            ...
            <div class="user-avatar-content">
              <!-- HEXAGON -->
              <div class="hexagon-image-68-74" data-src="/Uploads/avatars/{{$fundi->avatar}}"></div>
              <!-- /HEXAGON -->
            </div>
            <!-- /USER AVATAR CONTENT -->
          ...
          <p class="user-short-description-title"><a href="/kilimofy/UserAccount/about_user_page/{{$fundi->id}}-About-{{$fundi->name}}-in-Kilimofy-Platform">{{$fundi->name}}</a></p>
          <!-- /USER SHORT DESCRIPTION TITLE -->

          <!-- USER SHORT DESCRIPTION TEXT -->
          <p class="user-short-description-text"><a href="#">@ {{strtolower($fundi->name)}}</a></p>
          <!-- /USER SHORT DESCRIPTION TEXT -->
        </div>
        <!-- /USER SHORT DESCRIPTION -->
        ...
        <div class="user-stats">
          ...
          <div class="user-stat">
            ...
            <!-- USER STAT TEXT -->
            <p class="user-stat-text">Huduma</p>
            <!-- /USER STAT TEXT -->
          </div>
          <!-- /USER STAT -->
          ...
          <div class="user-stat">
            ...
            <!-- USER STAT TEXT -->
            <p class="user-stat-text">Wateja</p>
            <!-- /USER STAT TEXT -->
          </div>
          <!-- /USER STAT -->
        </div>
      ...
      <div class="user-preview-footer">
        ...
        <div class="user-preview-footer-action">
          <!-- BUTTON -->
          <a href="/kilimofy/UserAccount/about_user_page/{{$fundi->id}}-About-{{$fundi->name}}-in-Kilimofy-Platform" class="button void void-secondary">
            <!-- BUTTON ICON -->
    ...
    <!-- /USER PREVIEW -->
    @empty
    <p class="progress-arc-summary-subtitle text-center text-danger"> Hatuna Fundi wa Mashine Za Kilimo kutoka {{$user_location}} kwa sasa !</p>
    @endforelse
  </div>
  <!-- /GRID -->
