...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/kilimofy/Muuzaji-Wa-Pembejeo-Na-Viwatilifu/home-page" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="/assets/img/logo/logo_black.png" alt="Kilimofy Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Kilimofy</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/kilimofy/Admin/users-list" class="nav-link @yield('table-active-link')">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/kilimofy/Admin/register-new-staff" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New Staff</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/kilimofy/Admin/New-Forum-Category-Form" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New Forum Category</p>
                </a>
              </li>
              <li class="nav-item">
